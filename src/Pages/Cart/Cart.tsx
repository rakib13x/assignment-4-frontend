        ...
        <div className="lg:max-w-[1440px] md:max-w-[744px] max-w-[375px] w-full  py-12 bg-white mx-auto ">
          ...
          <div className="hidden px-4 lg:block md:block lg:px-10 md:px-6">
            <div className="flex justify-between ">
              ...
              <p className="2xl:hidden lg:block md:hidden hidden" />
              <p className="2xl:block lg:hidden md:hidden hidden" />
              <p className="2xl:hidden xl:block lg:hidden md:hidden hidden" />
              {/* <p  class="2xl:hidden xl:block lg:hidden md:hidden hidden"></p> */}
              <p className="text-lg font-medium leading-tight text-gray-600  lg:text-xl">
                Quantity
              </p>
          ...
          <div className="flex flex-col px-4 mt-10 md:flex-row items-strech md:mt-14 lg:mt-10 lg:px-10 md:px-6">
            <div className>
              <img
                src="https://tuk-cdn.s3.amazonaws.com/can-uploader/stool12121212.png"
                alt="wooden stool"
                role="img"
                className="object-contain max-w-[150px] lg:block md:block hidden"
              />
              <img
                src="https://tuk-cdn.s3.amazonaws.com/can-uploader/pro000.png"
                alt="pro"
            ...
            <div className="justify-between hidden w-full md:flex">
              <div className="flex flex-col justify-center md:ml-6 lg:ml-8">
                ...
                <p className="text-sm leading-normal text-gray-600">
                  Delivery: <span className="font-medium"> Time: 2 days</span>
                </p>
            ...
            <div className="flex flex-col mt-4 md:hidden">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm leading-normal text-gray-600">
                    Color: <span className="font-medium"> Light Brown</span>
                  </p>
                  <p className="text-sm leading-normal text-gray-600">
                    Delivery: <span className="font-medium"> Time: 2 days</span>
                  </p>
                  <p className="text-sm leading-normal text-gray-600">
                    Estimated Cost:{" "}
                    <span className="font-medium"> +$360 from China</span>
                  </p>
                </div>
              </div>
              ...
              <div className="flex justify-between items-center mt-6">
                <div className="flex items-center justify-between w-20 h-10 p-3 space-x-3 border border-gray-300 ">
                  <button
                    className="outline-none"
                    onClick={() =>
                      setCounter2(counter1 - 1 < 0 ? 0 : counter1 - 1)
                    }
                    aria-label="decrease quantity"
                  >
                    <svg
                  ...
                  <button
                    className="outline-none"
                    onClick={() => setCounter2(counter1 + 1)}
                    aria-label="increase quantity"
                  >
                    <svg
                      width={12}
                ...
                <div>
                  <p className="text-xl font-medium text-gray-800 ">$450</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:hidden md:block hidden">
            <div className="flex  justify-between lg:px-10 md:x-6 px-4">
              <div className="flex justify-between border border-gray-200 py-4 max-w-[296px] w-full px-4">
                <p className="text-base leading-none text-gray-600">Discount</p>
                <p className="text-base leading-none text-gray-600">$0.00</p>
              </div>
              <div className="flex justify-between border border-gray-200 py-4  max-w-[296px] w-full px-4">
            ...
            <div className="flex  justify-between lg:px-10 md:x-6 px-4 mt-4">
              <div className="flex justify-between border border-gray-200 py-4  max-w-[296px] w-full px-4">
                <p className="text-base leading-none text-gray-600">Subtotal</p>
                <p className="text-base leading-none text-gray-600">$0.00</p>
              </div>
